...
void main() async {
  ...
  final keyApplicationId = 'FrQ89STPHeiRKcY47yl1beJj884Zke23sEiICjrL';
  final keyClientKey = 'CRPCIZDd3BLhfM71cB2Lmxn0dss3WV0YdY42dMgU';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        style:
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 198, 201, 219))
       ),
        backgroundColor: Color.fromARGB(255, 44, 4, 79),
        centerTitle: true,
        actions: [
          PopupMenuButton(
        ...
        builder: (context, snapshot) {
          switch (snapshot.connectionState) {
            ...
            case ConnectionState.waiting:
              return const Center(
                child: Text("Welcome to TaskTide"),
              );
            default:
...
class _EditTaskScreenState extends State<EditTaskScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('TaskTide - Edit', style:
              TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 240, 237, 243))),
        backgroundColor:  Color.fromARGB(255, 44, 4, 79),
        centerTitle: true
      ),
      body: Padding(
          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: Color.fromARGB(255, 248, 239, 239), // Background color 
              ),
              onPressed: () async {
              ...
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color:  Color.fromARGB(255, 44, 4, 79))),
            ),
          ],
        ),
      ),
...
class _AddTaskScreenState extends State<AddTaskScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('TaskTide - Add', style:
              TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color:  Color.fromARGB(255, 226, 221, 231))),
        backgroundColor: Color.fromARGB(255, 44, 4, 79),
        centerTitle: true
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: Color.fromARGB(255, 233, 233, 237), // Background color
              ),
              onPressed: () async {
              ...
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 36, 11, 80))),
            ),
          ],
        ),
      ),
