...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('TaskTide - Login', style:
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(226, 238, 247, 1))),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Center(
                child: const Text('Cross Platfrom Application Development Assignment-1',
                    style:
              ...
              Center(
                child: const Text('Student ID: 2021MT70690',
                    style:
                        TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 42, 42, 42))),
              ),
              SizedBox(
            ...
            Center(
                child: const Text('TaskTide',
                    style:
                        TextStyle(fontSize: 30, fontWeight: FontWeight.bold, color: Color.fromRGBO(95, 12, 191, 1))),
              ),
              SizedBox(
                height: 2,
              ),
              Center(
                child: const Text('Stay up-to-date with TaskTide App',
    ...
    backgroundColor: Color.fromARGB(255, 204, 186, 220),
    );
  }
