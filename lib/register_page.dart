...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar( title: const Text('TaskTide - Register', style:
              TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Color.fromRGBO(197, 211, 222, 1))),
          ...
          children: [
            Center(
                child: const Text('Enter your details',
                    style: TextStyle(fontSize: 19, fontWeight: FontWeight.bold,color: Color.fromARGB(255, 42, 42, 42))),
              ),
              SizedBox(
                height: 26,
              ),
